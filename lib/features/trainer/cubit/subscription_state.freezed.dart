...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( SubscriptionInitial value)?  initial,TResult Function( SubscriptionLoading value)?  loading,TResult Function( SubscriptionLoaded value)?  loaded,TResult Function( SubscriptionError value)?  error,required TResult orElse(),}){
final _that = this;
switch (_that) {
case SubscriptionInitial() when initial != null:
return initial(_that);case SubscriptionLoading() when loading != null:
return loading(_that);case SubscriptionLoaded() when loaded != null:
return loaded(_that);case SubscriptionError() when error != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( SubscriptionInitial value)  initial,required TResult Function( SubscriptionLoading value)  loading,required TResult Function( SubscriptionLoaded value)  loaded,required TResult Function( SubscriptionError value)  error,}){
final _that = this;
switch (_that) {
case SubscriptionInitial():
return initial(_that);case SubscriptionLoading():
return loading(_that);case SubscriptionLoaded():
return loaded(_that);case SubscriptionError():
return error(_that);}
}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( SubscriptionInitial value)?  initial,TResult? Function( SubscriptionLoading value)?  loading,TResult? Function( SubscriptionLoaded value)?  loaded,TResult? Function( SubscriptionError value)?  error,}){
final _that = this;
switch (_that) {
case SubscriptionInitial() when initial != null:
return initial(_that);case SubscriptionLoading() when loading != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( SubscriptionDto subscription)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case SubscriptionInitial() when initial != null:
return initial();case SubscriptionLoading() when loading != null:
return loading();case SubscriptionLoaded() when loaded != null:
return loaded(_that.subscription);case SubscriptionError() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( SubscriptionDto subscription)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case SubscriptionInitial():
return initial();case SubscriptionLoading():
return loading();case SubscriptionLoaded():
return loaded(_that.subscription);case SubscriptionError():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( SubscriptionDto subscription)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case SubscriptionInitial() when initial != null:
return initial();case SubscriptionLoading() when loading != null:
return loading();case SubscriptionLoaded() when loaded != null:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SubscriptionLoaded&&(identical(other.subscription, subscription) || other.subscription == subscription));
}
