...
mixin _$RegisterResponse {
 ...
 String get userId; String get message; bool get requiresSubscription; bool get confirmationRequired;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,userId,message,requiresSubscription,confirmationRequired);

@override
String toString() {
  return 'RegisterResponse(userId: $userId, message: $message, requiresSubscription: $requiresSubscription, confirmationRequired: $confirmationRequired)';
}
...
@useResult
$Res call({
 String userId, String message, bool requiresSubscription, bool confirmationRequired
});
...
/// Create a copy of RegisterResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = null,Object? message = null,Object? requiresSubscription = null,Object? confirmationRequired = null,}) {
  return _then(_self.copyWith(
userId: null == userId ? _self.userId : userId // ignore: cast_nullable_to_non_nullable
as String,message: null == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
as String,requiresSubscription: null == requiresSubscription ? _self.requiresSubscription : requiresSubscription // ignore: cast_nullable_to_non_nullable
as bool,confirmationRequired: null == confirmationRequired ? _self.confirmationRequired : confirmationRequired // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String userId,  String message,  bool requiresSubscription,  bool confirmationRequired)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RegisterResponse() when $default != null:
return $default(_that.userId,_that.message,_that.requiresSubscription,_that.confirmationRequired);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String userId,  String message,  bool requiresSubscription,  bool confirmationRequired)  $default,) {final _that = this;
switch (_that) {
case _RegisterResponse():
return $default(_that.userId,_that.message,_that.requiresSubscription,_that.confirmationRequired);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String userId,  String message,  bool requiresSubscription,  bool confirmationRequired)?  $default,) {final _that = this;
switch (_that) {
case _RegisterResponse() when $default != null:
return $default(_that.userId,_that.message,_that.requiresSubscription,_that.confirmationRequired);case _:
  return null;
...
class _RegisterResponse implements RegisterResponse {
  const _RegisterResponse({required this.userId, required this.message, required this.requiresSubscription, required this.confirmationRequired});
  factory _RegisterResponse.fromJson(Map<String, dynamic> json) => _$RegisterResponseFromJson(json);

@override final  String userId;
@override final  String message;
@override final  bool requiresSubscription;
@override final  bool confirmationRequired;
...
/// Create a copy of RegisterResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = null,Object? message = null,Object? requiresSubscription = null,Object? confirmationRequired = null,}) {
