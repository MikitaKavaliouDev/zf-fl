...
mixin _$TrainerPreviewMediaDto {
 ...
 String get id; String? get trainerId; int get order; String get type; String get url; String? get thumbnailUrl; String? get caption;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,trainerId,order,type,url,thumbnailUrl,caption);

@override
String toString() {
  return 'TrainerPreviewMediaDto(id: $id, trainerId: $trainerId, order: $order, type: $type, url: $url, thumbnailUrl: $thumbnailUrl, caption: $caption)';
}
...
@useResult
$Res call({
 String id, String? trainerId, int order, String type, String url, String? thumbnailUrl, String? caption
});
...
/// Create a copy of TrainerPreviewMediaDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? trainerId = freezed,Object? order = null,Object? type = null,Object? url = null,Object? thumbnailUrl = freezed,Object? caption = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String? trainerId,  int order,  String type,  String url,  String? thumbnailUrl,  String? caption)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TrainerPreviewMediaDto() when $default != null:
return $default(_that.id,_that.trainerId,_that.order,_that.type,_that.url,_that.thumbnailUrl,_that.caption);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String? trainerId,  int order,  String type,  String url,  String? thumbnailUrl,  String? caption)  $default,) {final _that = this;
switch (_that) {
case _TrainerPreviewMediaDto():
return $default(_that.id,_that.trainerId,_that.order,_that.type,_that.url,_that.thumbnailUrl,_that.caption);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String? trainerId,  int order,  String type,  String url,  String? thumbnailUrl,  String? caption)?  $default,) {final _that = this;
switch (_that) {
case _TrainerPreviewMediaDto() when $default != null:
return $default(_that.id,_that.trainerId,_that.order,_that.type,_that.url,_that.thumbnailUrl,_that.caption);case _:
  return null;
...
class _TrainerPreviewMediaDto implements TrainerPreviewMediaDto {
  const _TrainerPreviewMediaDto({required this.id, this.trainerId, required this.order, required this.type, required this.url, this.thumbnailUrl, this.caption});
...
/// Create a copy of TrainerPreviewMediaDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? trainerId = freezed,Object? order = null,Object? type = null,Object? url = null,Object? thumbnailUrl = freezed,Object? caption = freezed,}) {
